...
internal actual fun aesCtrEncrypt(key: ByteArray, iv: ByteArray, plaintext: ByteArray): ByteArray = processCipher(Cipher.ENCRYPT_MODE, key, iv, plaintext)

internal actual fun aesCtrDecrypt(key: ByteArray, iv: ByteArray, ciphertext: ByteArray): ByteArray = processCipher(Cipher.DECRYPT_MODE, key, iv, ciphertext)
